    ...
    document.addEventListener('click', function(e){
      ...
      if (allDone) {
        ...
        if (localStorage.getItem(rewardGivenKey)) {
          ...
          // persist the current per-card completed set (we already toggled this card above)
          saveCompleted(Array.from(persistedCompleted));
          // do NOT clear other cards' completed state; only this card was changed above
        }
      }
    });
  })();
