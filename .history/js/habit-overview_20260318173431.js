(function(){
  document.addEventListener('DOMContentLoaded', function(){
    ...
    try{ console.debug('progress-list children:', container.children.length); }catch(e){}
  ...
  (function renderInsights(){
    ...
    `.trim());
      ...
      try{ console.debug('insight-cards children:', insightRoot.children.length); }catch(e){}
