(function(){
  document.addEventListener('DOMContentLoaded', function(){
    ...
    try{ console.debug('progress-list children:', container.children.length, 'first child:', container.children[0] && container.children[0].outerHTML.slice(0,200)); }catch(e){}
  ...
  (function renderInsights(){
    ...
    `.trim());
      ...
      try{ console.debug('insight-cards children:', insightRoot.children.length, 'first card:', insightRoot.children[0] && insightRoot.children[0].outerHTML.slice(0,200)); }catch(e){}
