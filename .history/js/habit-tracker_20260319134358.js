(function(){
  ...
  if(confirmCancel) confirmCancel.addEventListener('click', function(){ pendingDelete = null; confirmModal.classList.remove('show'); }; confirmModal.setAttribute('aria-hidden','true'); );
